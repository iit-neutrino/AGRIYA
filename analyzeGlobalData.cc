...
//  }
  ...
  for (int i=0;i<3; i++) {
    ...
    minimum->Contour(0,1,nSteps,xValues51,yValues51);
    minimum->Contour(0,1,nSteps,xValues89,yValues89);
    minimum->Contour(0,1,nSteps,xValues81,yValues81);
    minimum->Contour(0,1,nSteps,xValues91,yValues91);
    minimum->Contour(0,1,nSteps,xValuess22dm2,yValuess22dm2);
