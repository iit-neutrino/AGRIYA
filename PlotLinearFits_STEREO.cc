...
int main(int argc, char *argv[]){
  ...
  TGraphErrors *gExp3=new TGraphErrors();
  gExp3->SetPoint(0,0.0,6.50);
  gExp3->SetPointError(0,0.0,0.026);
  TGraphErrors *gExpSysts3=new TGraphErrors();
  gExpSysts3->SetPoint(0,-0.003,6.50);
  gExpSysts3->SetPoint(1,0.003,6.50);
  gExpSysts3->SetPointError(0,-0.003,0.165);
  gExpSysts3->SetPointError(1,0.003,0.165);
...
//  mg->Add(gFit2,"AL");
  ...
  mg->Add(gExpSysts3,"A3");
  
  mg->Draw("ALPE");
//    mg->GetYaxis()->SetRangeUser(5.7,7);
  mg->GetXaxis()->SetTitle("#it{F}_{239}");
//  mg->GetXaxis()->SetRangeUser(-0.5,0.5);
  ...
  gExp3->SetMarkerStyle(20);
  gExp3->SetMarkerColor(kBlack);
  gExp3->SetLineWidth(2);
  gExp3->SetMarkerSize(1.5);
  gExp3->SetLineColor(kBlack);
  gExpSysts3->SetLineColorAlpha(kBlack,1);
  gExpSysts3->SetLineWidth(1);
  gExpSysts3->SetFillColorAlpha(kBlack,0.7);
  gExpSysts3->SetFillStyle(3005);
  
  TLegend *leg= new TLegend(0.7,0.65,0.88,0.88);
  leg->SetBorderSize(0);
  leg->AddEntry(gExp2,"Daya Bay","PE");
//  leg->AddEntry(gFit2,"Daya Bay Fit");
  leg->AddEntry(gExp1,"RENO","PE");
  leg->AddEntry(gExp3,"STEREO","PE");
